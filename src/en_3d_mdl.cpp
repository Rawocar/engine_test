...
void CModel_3D::create_sphere(float radius, float num_v, uint8_t red, uint8_t green, uint8_t blue)
{
...
void CModel_3D::create_pyramid(float size, float to_peak, uint8_t red, uint8_t green, uint8_t blue)
{
	float r = (float)((float) red / (float) 255);
	float g = (float)((float) green / (float) 255);
	float b = (float)((float) blue / (float) 255);
...
void CModel_3D::create_cone(float radius, float to_peak, float num_v, uint8_t red, uint8_t green, uint8_t blue)
{
	float r = (float)((float) red / (float) 255);
	float g = (float)((float) green / (float) 255);
	float b = (float)((float) blue / (float) 255);
