  ...
  private:
	...
	public:
		...
		*/
		...
		void create_sphere(float, float, uint8_t, uint8_t, uint8_t);
		...
		*/
		...
		void create_pyramid(float, float, uint8_t, uint8_t, uint8_t);
		...
		*/
		...
		void create_cone(float, float, float, uint8_t, uint8_t, uint8_t);
};
